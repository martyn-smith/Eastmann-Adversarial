...
C  integrate additional states, NN must be increased accordingly in the calling
C  program.  The additional states should be appended to the end of the YY 
C  vector, e.g. YY(51),...  The additional derivatives should be appended to 
C  the end of the YP vector, e.g. YP(51),...  To initialize the new states 
C  and to calculate derivatives for them, we suggest creating new function 
C  evaluator and initialization routines as follows.
C
C          C-----------------------------------------------
C          C
...
C      conjunction  with another 
C      disturbance as stated in the paper.  All disturbances can
C      be used alone or in any combination.
C
C
