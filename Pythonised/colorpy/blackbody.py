...
def figures():
    ...
    blackbody_color_vs_temperature_plot(
        list(range(1200, 16000, 50)), "Blackbody Colors", "Blackbody-Colors"
    )
    blackbody_color_vs_temperature_plot(
        list(range(10000, 40000, 100)), "Hot Blackbody Colors", "Blackbody-HotColors"
    )
    blackbody_color_vs_temperature_plot(
        list(range(950, 1200, 1)), "Cool Blackbody Colors", "Blackbody-CoolColors"
    )
