...
!          c
!                integer nn
!                double precision time, state(nn), derivative(nn)
!          c
...
!    include 'tecommon.inc'
    ...
    uclc,utlc,xlc, &
    etc,esc,tcc,dlc, &
    vlc,vtc,quc,ucvv,utvv,xvv, &
    etv,esv,tcv,tkv,vtv,ptv,vcv,vrng,vtau, &
    ftm,fcm,xst,xmws,hst,tst,sfr,cpflmx,cpprmx,cpdh, &
    tcwr,tcws,htr,agsp,xdel,xns,tgas,tprod,vst
    integer &
    ivst
    common/teproc/ &
    ...
    tcs,tks,dls, &
    vls,vvs,vts, &
    pts,pps(8),fws,tws,qus,hws, &
    uclc(8),utlc,xlc(8),etc,esc,tcc,dlc,vlc,vtc,quc, &
    ucvv(8),utvv,xvv(8),etv,esv,tcv,tkv, &
    vtv,ptv,vcv(12),vrng(12),vtau(12), &
    ftm(13),fcm(8,13),xst(8,13),xmws(13), &
    hst(13),tst(13),sfr(8),cpflmx,cpprmx,cpdh, &
    tcwr,tcws,htr(3),agsp,xdel(41),xns(41), &
    ...
    spspan(12), &
    idvwlk(12)
    double precision avp,bvp,cvp, ad,bd,cd, ah,bh,ch, ag,bg,cg, av, xmw
    common/const/ &
    avp(8),bvp(8),cvp(8), &
    ah(8),bh(8),ch(8), &
    ag(8),bg(8),cg(8), &
    ...
    derivative(36)=hst(1)*ftm(1)+ &
                    ...
                    hst(9)*ftm(9)- &
                    hst(6)*ftm(6)
    derivative(37)=(fwr*500.53* (tcwr-twr)-qur*1.d6/1.8)/hwr
    derivative(38)=(fws*500.53* (tcws-tws)-qus*1.d6/1.8)/hws 
    ivst(10)=idv(14)
    ivst(11)=idv(15)
    ivst(5)=idv(19)
    ivst(7)=idv(19)
...
!
    ...
    fws,tws,qus,hws, &
    uclc,utlc,xlc, &
    etc,esc,tcc,dlc,vlc,vtc,quc, &
    ucvv,utvv,xvv,etv,esv,tcv,tkv, &
    vtv,ptv,vcv,vrng,vtau,ftm,fcm,xst,xmws, &
    hst,tst,sfr,cpflmx,cpprmx,cpdh,tcwr,tcws, &
    ...
    xls(8),xvs(8),ets,ess, &
    tcs,tks,dls, &
    vls,vvs,vts,pts,pps(8), &
    fws,tws,qus,hws,uclc(8),utlc,xlc(8),etc,esc,tcc,dlc, &
    vlc,vtc,quc,ucvv(8),utvv,xvv(8), &
    etv,esv,tcv,tkv,vtv,ptv, &
    ...
    xmw(8)
    integer i, nn
    double precision state(nn), derivative(nn), time

    ! pub const AV : [f64; 8] = [1.0e-6, 1.0e-6, 1.0e-6, 86.7e-6, 160.0e-6, 160.0e-6, 225.0e-6, 209.0e-6];
...
subroutine tesub2(z, t, h, ity)
    ...
    xmw(8)
    integer ity, j
    double precision dh, dt, h, htest, t, tin, z(8)
...
subroutine tesub3(z, t, dh, ity)
    ...
    ad(8),bd(8),cd(8), &
    xmw(8)
    double precision dh, dhi, r, t, z(8)
...
subroutine tesub5(s, sp, adist, bdist, cdist, ddist, tlast, tnext, &
    ...
    double precision s, sp, h, s1, s1p, &
...
double precision function tesub8(i, t) !returns a double, as it should
    integer i, idvwlk
